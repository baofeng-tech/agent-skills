"""Core data model for the v1.0.0 last30days pipeline."""
...
class ProviderRuntime:
    ...
    reasoning_provider: Literal["aisa", "gemini", "openai", "xai", "openrouter", "local"]
    planner_model: str
    rerank_model: str
    x_search_backend: Literal["aisa", "xai", "bird"] | None = None
