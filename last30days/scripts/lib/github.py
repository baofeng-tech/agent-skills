...
per-item comment enrichment. Auth via GH_TOKEN/GITHUB_TOKEN env var
or `gh auth token` subprocess fallback.
"""
...
def search_github(
    ...
    if not resolved_token:
        _log("No GitHub token available (set GH_TOKEN/GITHUB_TOKEN or install gh CLI)")
        return []
